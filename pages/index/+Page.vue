...
<template>
	<main
		class="min-h-dvh flex flex-col items-center justify-center px-4 bg-[#0d0d0f]"
	>
		<div class="w-full max-w-sm flex flex-col gap-6">
			<div class="flex flex-col gap-1">
				<h1 class="text-xl font-bold text-white tracking-tight">User Lookup</h1>
				<p class="text-sm text-discord-faint">
					Enter a Discord snowflake ID to view a profile.
				</p>
			</div>
			<div class="flex flex-col gap-2">
				...
				>
					<svg
						class="shrink-0 text-discord-faint"
						width="15"
						height="15"
						viewBox="0 0 24 24"
						fill="none"
