...
<template>
	<main
		class="relative min-h-dvh flex flex-col items-center justify-center px-4 py-12 overflow-hidden"
	>
		<div class="absolute inset-0 -z-10" aria-hidden="true">
			...
			<div
				...
				:style="
					{
						background:
							`radial-gradient(ellipse at 30% 40%, ${user.embed_color}55 0%, #0d0d0f 65%)`,
					}
				"
			/>
